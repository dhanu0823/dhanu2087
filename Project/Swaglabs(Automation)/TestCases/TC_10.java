...
public class TC_10 {
	...
	// The "purchase" data provider is located in the Dataprovider01 class
...
//Creating an instance of ChromeDriver
	...
	// Check if the title of the page matches "Swag Labs"
			...
			// Flush the results of the test to the report// Flush the results of the test to the report
			  	extent.flush();
