...
public class TC_07 {	
	...
	public void Productcatolog4(String username, String password ) throws InterruptedException {
	...
	// Pausing execution for 2 seconds
	  Thread.sleep(2000);
	  // invokes the clickoption4() method on the object "obj".
	  obj.clickoption4();
	// Pausing execution for 2 seconds
      Thread.sleep(2000);
...
// Create an instance of the ExtentReports class
 ...
 // Attach the html report to the ExtentReports instance
	...
	// Check if the title of the page matches "Swag Labs"
	  ...
	  test.pass("productcatalog Name High to Low"); 		}
	else
