...
public class TC_08 {
	...
	public void item1(String username, String password ) throws InterruptedException {
...
//Attach the html report to the ExtentReports instance
    ...
    test.pass("Item is displayed as expected");		}		
    else// if title does not match, log the failure message
	{     test.fail("Item is not displayed as expected");	 	}
