...
public void Productcatolog2(String username, String password) throws InterruptedException {
...
//Pausing execution for 2 seconds
  Thread.sleep(2000);
  // invokes the clickoption2() method on the object "obj".
  obj.clickoption2();
//Pausing execution for 2 seconds
  Thread.sleep(2000); 
...
test.pass("productcatalog Name Z to A");  }
 else
